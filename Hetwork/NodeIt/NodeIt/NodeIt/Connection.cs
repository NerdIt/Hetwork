...
namespace NodeIt
{
    public class NodeConnection
    {
        ...
        public NodeConnection(NodeVisual node1, NodeVisual node2)
        {
            n1 = node1;
            n2 = node2;
        ...
        public bool IsHoveringWithinConnectionPoint(Point mouse, Point offset)
        {
        ...
        public NodeVisual GetClosestPoint(Point p, Point offset)
        {
